...
export default function ProjectCollection({ projects }) {
  ...
  return (
    <div className="project-collection">
      <div
        className="project-collection__filters"
        role="tablist"
        ...
        {PROJECT_CATEGORIES.map((category) => {
          ...
          return (
            <button
              ...
              className={`project-collection__filter${isActive ? " is-active" : ""}`}
        ...
        {filtered.map((project, index) => (
          <li key={project.slug} sa={`up slow mirror delay-${(index + 1) * 100}`}>
            ...
            >
              ...
              <span className="project-collection__entry-main">
              ...
              <span className="project-collection__entry-meta">
              ...
              <span className="project-collection__entry-arrow" aria-hidden="true">
