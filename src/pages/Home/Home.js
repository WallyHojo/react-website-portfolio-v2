...
function Home() {
  ...
  return (
    <section className="section section-hero section-grain grain__medium section-padding height-viewport">
      <div className="hero__decor">
        ...
        <div className="hero__shape dots-svg dots--1" sa="fade glacial delay-200">
          <img src={handleDots} alt="Handle dots"clipPath />
        </div>
        <div className="hero__shape dots-svg dots--2" sa="fade glacial delay-400">
          <img src={handleDots} alt="Handle dots"clipPath />
        </div>
        <div className="hero__shape arrow-down-svg arrow-down--1" sa="fade glacial delay-600">
          <img src={arrowDownDrop1f} alt="Arrow down drop"clipPath />
        </div>
        <div className="hero__shape arrow-down-svg arrow-down--2" sa="fade glacial delay-800">
          <img src={arrowDownDrop2e} alt="Arrow down drop"clipPath />
        </div>
      </div>

      <div className="content flex-all flex-vert-bottom height-full">
        <div className="text flex-half" sa="up-long fade glacial">
          <h1 className="heading" sa="up slower delay-200">{displayText}</h1>
